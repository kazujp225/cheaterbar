            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="space-y-2">
                ...
                <Input
                  ...
                  required
                  placeholder="例: 起業家が成功するための5つの習慣"
                />
              </div>
              ...
              <div className="space-y-2">
                ...
                <Textarea
                  ...
                  required
                  rows={3}
                  placeholder="記事の概要を入力してください（一覧ページに表示されます）"
                />
              </div>
              ...
              <div className="space-y-2">
                ...
                <Textarea
                  ...
                  required
                  rows={15}
                  placeholder="記事の本文を入力してください（Markdownに対応しています）"
                  className="font-mono"
                />
              ...
              <div className="flex items-center space-x-2">
                ...
                />
                <Label htmlFor="published">すぐに公開する</Label>
              </div>

              <div className="flex gap-4">
                <Button type="submit" className="flex-1">
                  {formData.published ? "記事を公開" : "下書きとして保存"}
                </Button>
